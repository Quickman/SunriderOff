...
##############SUNRIDER WEAPONS
    class SunriderLaser(Laser):
        def __init__(self):
            ...
            harder to hit, such as Ryders. 15 range penalty per tile."""
    ...
    class SunriderMissile(Missile):
        def __init__(self):
            ...
            All missile based weaponry receives one third ranged penalties.
    ...
    class SunriderKinetic(Kinetic):
        def __init__(self):
            ...
            laser, pulse or assault weaponry. 15 accuracy penalty / tile."""
    ...
    class SunriderPulse(Laser):
        def __init__(self):
            ...
            and not doubling armour, is where their true power lies. 15 penalty / tile"""
    ...
    class SunriderRocket(Missile):
        def __init__(self):
            ...
            5 range penalty per tile to accuracy."""
...
###################BLACK JACK WEAPONS
    ...
    class BlackjackLaser(Laser):
        def __init__(self):
            ...
            armoured ships that lack heavy shield coverage. 15 acc penalty per tile.
    ...
    class BlackjackMissile(Missile):
        def __init__(self):
            ...
            firepower for merely one Ryder - but only so many times per combat. 5 penalty/tile.
    ...
    class BlackjackPulse(Laser):
        def __init__(self):
            ...
            Justice comes in the form of rapid fire plasma! 15 Aim penalty / Tile
            Reduced by shields and armour."""
    ...
    class BlackjackAssault(Kinetic):
        def __init__(self):
            ...
            and applied to each shot. 15 aim penalty / tile."""
    ...
    class BlackjackMelee(Melee):
        def __init__(self):
            ...
            Reduced by armour.""" # I honestly feel after writing these that I could have just done it into superclass melee/laser/missile/kinetic for non support weapons, really. Ah, well.
...
#############################################LIBERTY WEAPONS
    ...
    class LibertyLaser(Laser):
        def __init__(self):
            ...
            15 aim penalty per tile. Reduced by shields and armour."""
...
###################PALADIN WEAPONS
    ...
    class PaladinMissile(Missile):
        def __init__(self):
            ...
            Otherwise identical to the Black Jack's missiles. -5 Aim per tile."""
    ...
    class PaladinAssault(Kinetic):
        def __init__(self):
            ...
            -15 aim penalty per tile. Reduced by 2x armour per shot."""
    ...
    class PaladinKinetic(Kinetic):
        def __init__(self):
            ...
            Terrifying. Reduced by 2x armour, but even that won't save them. -15 aim/tile."""
 ...
 ###########################################PHOENIX
    ...
    class PhoenixAssault(Kinetic):
        def __init__(self):
            ...
            -15 aim per tile, reduced by 2x armour per shot."""
    ...
    class PhoenixMelee(Melee):
        def __init__(self):
            ...
            Reduced by armour each strike. They still won't survive."""
...
################################################# SERAPHIM
    class SeraphimKinetic(Kinetic):
        def __init__(self):
            ...
            Good against absolutely everything. -15 Aim/tile.
            Reduced by armour."""
...
################################################### BIANCA
    ...
    class BiancaAssault(Kinetic):
        def __init__(self):
            ...
            Reduced by armour. -15 aim per tile."""
